...
* `yarn start` (or `GD_URL=e2e-demo13.na.gooddata.com yarn start`)
...
This app is configured to run against https://e2e-demo13.na.gooddata.com/. For access, you can register at https://gooddata-examples.herokuapp.com/.
