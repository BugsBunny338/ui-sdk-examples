...
export const CustomerCity = {
   ...
   */
  Coordinates: newAttribute(
    "label.customers.customercity.customercitycoordinates"
  )
};
/**
...
export const TargetQuarterRevenue = newMeasure(
  idRef("adqRcst5d10N", "measure")
);
/**
...
export const TotalQuarterRevenuePreviousYear = newMeasure(
...
export const TotalRevenueThisQuarter = newMeasure(
  idRef("aceRa2RVaVEJ", "measure")
);
/**
 * Fact Title: Budget
